...
const draggableComponent = {
  ...
  render(h) {
    ...
    const attributes = getComponentAttributes(this.options, this.componentData);
  ...
  mounted() {
    ...
    // const attributes = Object.keys(this.$props).reduce((res, key) => {
    //   res[camelize(key)] = this.$props[key];
    //   return res;
    // }, {});
